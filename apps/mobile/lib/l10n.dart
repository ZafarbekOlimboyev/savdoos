...
const Map<String, String> _ru = {
  ...
  'Ko‘p urinish — {t} kuting': 'Много попыток — подождите {t}',
  ...
  // Xodimlar boshqaruvi
  'Xodimlar': 'Сотрудники', 'Yangi xodim': 'Новый сотрудник', 'Xodim kartasi': 'Карточка сотрудника',
  'Ism familiya': 'Имя и фамилия', 'Rol': 'Роль', 'Filial': 'Филиал',
  'Filial biriktirilmagan': 'Филиал не привязан',
  'Faol': 'Активен', "To'xtatilgan": 'Приостановлен',
  'Parol (ixtiyoriy)': 'Пароль (необязательно)',
  "O'chirilsa xodim tizimga kira olmaydi": 'Если выключить — сотрудник не сможет войти',
  'Oylik savdo': 'Продажи за месяц',
  "So'nggi 6 oy — savdo": 'Последние 6 мес — продажи',
  'RUXSATLAR': 'ПРАВА ДОСТУПА',
  'Administrator — barcha ruxsatlarga ega': 'Администратор — все права доступа',
  'Ega — barcha huquqlar': 'Владелец — полные права',
  'Boshqani administrator qilish': 'Назначать администраторов',
  "Buni faqat Ega o'zgartiradi": 'Это может менять только Владелец',
  "Ruxsatlarni faqat Ega yoki administrator o'zgartiradi": 'Права меняет только Владелец или администратор',
  "Ruxsatlarni faqat administrator o'zgartiradi": 'Права меняет только администратор',
  'Ruxsatlar yuklanmadi': 'Права не загрузились',
  "Ko'rish": 'Просмотр', "O'zgartirish": 'Изменение', 'Sotish': 'Продажа', 'Yaratish': 'Создание',
  'Kassa': 'Касса', 'Qaytarishlar': 'Возвраты',
  'Xaridlar': 'Закупки', 'Hisobot': 'Отчёты',
  "xodimni o'chirasizmi?": 'удалить сотрудника?', "O'chirish": 'Удалить',
  'Ism kiriting': 'Введите имя',
  'Dona': 'Штука', 'Kg (tarozi)': 'Кг (весовой)',
  'Birlik': 'Единица',
  'Shtrix-kod (majburiy)': 'Штрих-код (обязательно)',
  'Skanerlang yoki qo‘lda kiriting': 'Отсканируйте или введите вручную',
  'Tarozi PLU kodi (majburiy)': 'PLU код весов (обязательно)',
  'Masalan: 412 — tarozida shu kod bilan sotiladi': 'Например: 412 — на весах продаётся по этому коду',
  'Min qoldiq (ogohlantirish uchun, ixtiyoriy)': 'Мин. остаток (для оповещения, необязательно)',
  'avto': 'авто',
  'Bu kod band': 'Этот код занят',
  'Shtrix-kodni kiriting yoki skanerlang': 'Введите или отсканируйте штрих-код',
  'Tarozi PLU kodini kiriting': 'Введите PLU код весов',
  'Miqdor (kg)': 'Количество (кг)',
  'PLU kiriting': 'Введите PLU',
  'Shtrix-kod kiriting': 'Введите штрих-код',
  'ta yangi mahsulotda shtrix-kod/PLU yo‘q — kiriting yoki skanerlang': 'новых товаров без штрих-кода/PLU — введите или отсканируйте',
  'ta mahsulot tanlanmagan': 'товаров не выбрано',
  'Ikki yangi mahsulotda bir xil shtrix-kod — har biriga alohida kod bering': 'У двух новых товаров одинаковый штрих-код — задайте каждому свой',
  'Ikki yangi mahsulotda bir xil PLU — har biriga alohida PLU bering': 'У двух новых товаров одинаковый PLU — задайте каждому свой',
  ...
  'Hisobdan chiqarish': 'Списание', 'Brak, muddati o‘tgan': 'Брак, просрочка', 'Chiqarildi ✓': 'Списано ✓',
  ...
  'Xatolik': 'Ошибка', 'Katalog yangilanmoqda…': 'Каталог обновляется…',
  'tugadi': 'закончился', 'muddati o‘tgan': 'просрочен', 'kam qoldi': 'мало осталось', 'to‘lov': 'оплата',
  'Brak (nuqsonli)': 'Брак (дефект)', 'Tasdiqlash': 'Подтвердить', 'farq': 'расхождение', 'tayyor': 'готово', 'ta farq': 'расхождений', 'hisobdan chiqarildi': 'списан', 'mahsulot ko‘chirildi': 'товаров перемещено',
...
const Map<String, String> _ky = {
  ...
  'Ko‘p urinish — {t} kuting': 'Көп аракет — {t} күтүңүз',
  ...
  // Xodimlar boshqaruvi
  'Xodimlar': 'Кызматкерлер', 'Yangi xodim': 'Жаңы кызматкер', 'Xodim kartasi': 'Кызматкер картасы',
  'Ism familiya': 'Аты-жөнү', 'Rol': 'Роль', 'Filial': 'Филиал',
  'Filial biriktirilmagan': 'Филиал байланышкан эмес',
  'Faol': 'Активдүү', "To'xtatilgan": 'Токтотулган',
  'Parol (ixtiyoriy)': 'Сырсөз (милдеттүү эмес)',
  "O'chirilsa xodim tizimga kira olmaydi": 'Өчүрүлсө кызматкер кире албайт',
  'Oylik savdo': 'Айлык сатуу',
  "So'nggi 6 oy — savdo": 'Акыркы 6 ай — сатуу',
  'RUXSATLAR': 'УКУКТАР',
  'Administrator — barcha ruxsatlarga ega': 'Администратор — бардык укуктарга ээ',
  'Ega — barcha huquqlar': 'Ээси — толук укуктар',
  'Boshqani administrator qilish': 'Администратор дайындоо',
  "Buni faqat Ega o'zgartiradi": 'Муну Ээси гана өзгөртөт',
  "Ruxsatlarni faqat Ega yoki administrator o'zgartiradi": 'Уруксаттарды Ээси же администратор гана өзгөртөт',
  "Ruxsatlarni faqat administrator o'zgartiradi": 'Укуктарды администратор гана өзгөртөт',
  'Ruxsatlar yuklanmadi': 'Укуктар жүктөлгөн жок',
  "Ko'rish": 'Көрүү', "O'zgartirish": 'Өзгөртүү', 'Sotish': 'Сатуу', 'Yaratish': 'Түзүү',
  'Kassa': 'Касса', 'Qaytarishlar': 'Кайтарымдар',
  'Xaridlar': 'Сатып алуулар', 'Hisobot': 'Отчёттор',
  "xodimni o'chirasizmi?": 'кызматкерди өчүрөсүзбү?', "O'chirish": 'Өчүрүү',
  'Ism kiriting': 'Атын киргизиңиз',
  'Dona': 'Даана', 'Kg (tarozi)': 'Кг (таразалуу)',
  'Birlik': 'Бирдик',
  'Shtrix-kod (majburiy)': 'Штрих-код (милдеттүү)',
  'Skanerlang yoki qo‘lda kiriting': 'Сканерлеңиз же кол менен киргизиңиз',
  'Tarozi PLU kodi (majburiy)': 'Тараза PLU коду (милдеттүү)',
  'Masalan: 412 — tarozida shu kod bilan sotiladi': 'Мисалы: 412 — таразада ушул код менен сатылат',
  'Min qoldiq (ogohlantirish uchun, ixtiyoriy)': 'Мин. калдык (эскертүү үчүн, милдеттүү эмес)',
  'avto': 'авто',
  'Bu kod band': 'Бул код бош эмес',
  'Shtrix-kodni kiriting yoki skanerlang': 'Штрих-кодду киргизиңиз же сканерлеңиз',
  'Tarozi PLU kodini kiriting': 'Тараза PLU кодун киргизиңиз',
  'Miqdor (kg)': 'Саны (кг)',
  'PLU kiriting': 'PLU киргизиңиз',
  'Shtrix-kod kiriting': 'Штрих-код киргизиңиз',
  'ta yangi mahsulotda shtrix-kod/PLU yo‘q — kiriting yoki skanerlang': 'жаңы товарда штрих-код/PLU жок — киргизиңиз же сканерлеңиз',
  'ta mahsulot tanlanmagan': 'товар тандалган эмес',
  'Ikki yangi mahsulotda bir xil shtrix-kod — har biriga alohida kod bering': 'Эки жаңы товардын штрих-коду бирдей — ар бирине өзүнчө код бериңиз',
  'Ikki yangi mahsulotda bir xil PLU — har biriga alohida PLU bering': 'Эки жаңы товардын PLU коду бирдей — ар бирине өзүнчө PLU бериңиз',
  'Kategoriya': 'Категория',
  ...
  'Hisobdan chiqarish': 'Эсептен чыгаруу', 'Brak, muddati o‘tgan': 'Брак, мөөнөтү өткөн', 'Chiqarildi ✓': 'Чыгарылды ✓',
  ...
  'Xatolik': 'Ката', 'Katalog yangilanmoqda…': 'Каталог жаңырууда…',
  'tugadi': 'бүттү', 'muddati o‘tgan': 'мөөнөтү өткөн', 'kam qoldi': 'аз калды', 'to‘lov': 'төлөм',
  'Brak (nuqsonli)': 'Брак (кемтик)', 'Tasdiqlash': 'Ырастоо', 'farq': 'айырма', 'tayyor': 'даяр', 'ta farq': 'айырма', 'hisobdan chiqarildi': 'эсептен чыгарылды', 'mahsulot ko‘chirildi': 'товар которулду',
