...
YOZUVCHILAR = [
    ...
    # Phase 5G: mobil yo'llar MATNI va HOLATI o'zgarmagan — faqat `X-Error-Code` qo'shildi
    # (`app/core/error_codes.py`, mobil ilova kodni tarjima kaliti sifatida o'qiydi).
    ("mobil_qabul", "api/v1/receiving.py", _mobil_qabul,
     Javob(400, LOTS_MAJBURIY, "LOT_LINES_REQUIRED")),
    ("kochirish", "api/v1/cashops.py", _kochirish,
     Javob(409, _darvoza("filiallararo ko'chirish"), "TRANSFER_TRACKED_UNSUPPORTED")),
    ("sanoq", "api/v1/inventory.py", _sanoq,
     Javob(400, SANOQ_PARTIYASIZ, "LOT_LINES_REQUIRED")),
    ("hisobdan_chiqarish", "api/v1/inventory.py", _hisobdan_chiqarish,
     Javob(400, CHIQARISH_PARTIYASIZ, "LOT_LINES_REQUIRED")),
