...
const DYNAMIC: { re: RegExp; ru: string; uzc: string }[] = [
  ...
  { re: /^'(.+)' partiya bo'yicha kuzatiladi — kirim narxini tahrirlab bo'lmaydi: partiya tannarxi qabul paytida yozilgan va hujjat bilan jimgina ajralib qolardi\. Narx xato bo'lsa kirimni bekor qilib, to'g'ri narx bilan qayta qabul qiling\.$/, ru: "«$1» отслеживается по партиям — цену прихода изменить нельзя: себестоимость партии записана при приёмке и молча разошлась бы с документом. Если цена ошибочна, отмените приход и примите заново с верной ценой.", uzc: "«$1» партия бўйича кузатилади — кирим нархини таҳрирлаб бўлмайди: партия таннархи қабул пайтида ёзилган ва ҳужжат билан жимгина ажралиб қоларди. Нарх хато бўлса киримни бекор қилиб, тўғри нарх билан қайта қабул қилинг." },
