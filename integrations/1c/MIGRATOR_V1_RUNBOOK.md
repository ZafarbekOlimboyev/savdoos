...
| skipped_row_products | keep / deactivate_and_zero | o'tkazib yuborilgan qatorning mahsulotlari: operator tanlagan LINK/REACTIVATE maqsadi (keyin siyosat o'tkazgan), BLOCKED/SKIP qatorning GUID yoki yagona nomzodi. CREATE qarori berilgan qatorning nomzodi bunga KIRMAYDI (rad etilgan — `binos_missing_from_source`) |
